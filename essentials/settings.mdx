...
description: "Mintlify gives yousssss complete control over the look and feel of your documentation using the docs.json file"
icon: "gear"
---

Every Mintlify site needs a `docs.json` file with the core configuration settings. Learn more about the [properties](#properties) below.sssss
